...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light shadow p-3 mb-5 bg-white rounded sticky-top">
        <div class="container">
            <li class="nav-item">
  ...
  <footer class="text-center text-lg-start bg-light text-muted p-0">
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05);">
      © 2023 Copyright:
      <a class="text-reset fw-bold" href="https://www.taspen.co.id/">TASPEN</a>
    </div>
    <!-- Copyright -->
  </footer>
  <!-- Footer -->
