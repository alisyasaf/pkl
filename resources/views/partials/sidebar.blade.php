...
<nav class="position-static navigasi" style="background-color: #061755; height: 100%; width: 70px">
  <ul>
    <li>
      <a class="bars" href="/">
    ...
    <li>
      <a class="bars" href="#">
        ...
        <span class="nav-item">Mitra</span>
      </a>
    </li>
    ...
    <li>
      <a class="bars" href="#">
        ...
        <span class="nav-item">Verifikasi</span>
      </a>
    </li>
    ...
    <li>
      <a class="bars" href="#">
        ...
        <span class="nav-item">Generate Akun</span>
      </a>
    </li>
  </ul>
</nav>
...
{{-- <div class="l-navbar size" id="nav-bar">
    <nav class="nav">
