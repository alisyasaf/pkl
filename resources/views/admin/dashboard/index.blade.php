...
<div class="container flex-row" style="margin-left: 5%; margin-top: 1%">
    <div class="row">
    ...
    <div class="flex-column">
        ...
        <div class="p-2">
            <div class="d-flex flex-row justify-content-around" style="width: 66%">
                <div class="p-2">
    ...
    {{-- <div class="row">
        <div class="col align-justify-center">
            <button type="button" class="btn shadow p-3 mb-5 waves-effect mt-4" name="/" style="font-family: poppins; width: 300px; height: 100px; font-size: 20px; background-color: #E5E5E5">
            <div class="row justify-content-center align-items-center"><i class="fa-solid fa-user-group fa col-2 me-2" style="font-size: 33px" aria-hidden="true"></i>
            <div class="col-auto">Daftar Mitra</div></div></button>
        </div>
        <div class="col align-justify-center">
            <button type="button" class="btn shadow p-3 mb-5 waves-effect mt-4" name="/" style="font-family: poppins; width: 300px; height: 100px; font-size: 20px; background-color: #E5E5E5">
            <div class="row justify-content-center align-items-center"><i class="fa-regular fa-circle-question fa-2x col-2 me-2" style="font-size: 33px" aria-hidden="true"></i>
            <div class="col-auto">Edit FAQ</div></div></button>
        </div>
        <div class="col align-justify-center">
            <button type="button" class="btn shadow p-3 mb-5 waves-effect mt-4" name="/" style="font-family: poppins; width: 300px; height: 100px; font-size: 20px; background-color: #E5E5E5">
            <div class="row justify-content-center align-items-center"><i class="fa-regular fa-circle-check fa-2x col-2 me-2" style="font-size: 33px" aria-hidden="true"></i>
            <div class="col-5 text-left">Verifikasi Pembayaran</div></div></button>
        </div>
        </div>

        <div class="row">
            <div class="col align-justify-center" style="max-width: 63vh">
                <button type="button" class="btn shadow p-3 mb-5 waves-effect mt-4" name="/" style="font-family: poppins; width: 300px; height: 100px; font-size: 20px; background-color: #E5E5E5">
                <div class="row justify-content-center align-items-center"><i class="fa-solid fa-user-plus fa-2x col-2 me-2" style="font-size: 33px" aria-hidden="true"></i>
                <div class="col-auto">Generate Akun</div></div></button>
            </div>
            <div class="col align-justify-center">
                <button type="button" class="btn shadow p-3 mb-5 waves-effect mt-4" name="/" style="font-family: poppins; width: 300px; height: 100px; font-size: 20px; background-color: #E5E5E5">
                <div class="row justify-content-center align-items-center"><i class="fa-solid fa-message fa-2x col-2 me-2" style="font-size: 33px" aria-hidden="true"></i>
                <div class="col-auto">Forum</div></div></button>
            </div>
            <div class="col align-justify-center">
                <button type="button" class="btn shadow p-3 mb-5 waves-effect mt-5" name="/" style="font-family: poppins; width: 300px; height: 100px; font-size: 20px; background-color: #E5E5E5">
                <div class="row justify-content-center align-items-center"><i class="fa-regular fa-circle-check fa-2x col-2 me-2" aria-hidden="true"></i>
                <div class="col-5 text-left">Verifikasi Pembayaran</div></div></button>
            </div>
            </div> --}}
@endsection
